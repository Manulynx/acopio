...
class Producto(models.Model):
    ...
    requiere_vencimiento = models.BooleanField(
        default=False,
        help_text="Si el producto tiene fecha de vencimiento"
    )
    
    requiere_lote = models.BooleanField(
        default=False,
        help_text="Si el producto requiere control por lotes"
    )
...
class MovimientoStock(models.Model):
    """Registro de movimientos de stock de productos"""
    ...
    producto = models.ForeignKey(
        Producto, 
        on_delete=models.CASCADE,
        related_name='movimientos_productos_stock'
    )
    ...
    lote = models.ForeignKey(
        ...
        null=True, 
        blank=True,
        related_name='movimientos_productos'
    )
    ...
    usuario_responsable = models.ForeignKey(
        ...
        on_delete=models.SET_NULL, 
        null=True,
        related_name='movimientos_productos_responsable'
    )
    ...
    creado_por = models.ForeignKey(
        ...
        on_delete=models.SET_NULL, 
        null=True, 
        related_name='movimientos_productos_creados'
    )
